        ...
        child: Row(
            ...
            children: widget.tabs
                .map((t) => GButton(
                      ...
                      //separacion icono y texto
                      gap: MediaQuery.of(context).size.width*0.02 + MediaQuery.of(context).size.height*0.03333,
                      iconActiveColor: Color.fromRGBO(228, 228, 228, 1),
                      iconColor: Color.fromRGBO(228, 228, 228, 1),
                      //iconsize , totalmente inutil , ir al tamaño del boton para cambiar el tamaño del icono
                      iconSize:t.iconSize,
                      textColor: Color.fromRGBO(228, 228, 228, 1),
                      //padding , tamaño del fondo al pulsar + tamaño del gap
                      ...
                      text: t.text,
                      icon: t.icon,
                      color: Color.fromRGBO(34, 60, 71, 1),
                      onPressed: () {
                        setState(() {
