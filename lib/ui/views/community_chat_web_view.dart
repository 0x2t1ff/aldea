...
import 'package:aldea/viewmodels/community_chat_web_viewmodel.dart';
...
class CommunityChatWebView extends StatelessWidget {
  final String communityId;
  final double height;
  final bool petitionsShowing;

  const CommunityChatWebView(
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<CommunityChatWebViewModel>.reactive(
      viewModelBuilder: () => CommunityChatWebViewModel(),
                    ...
                    ? StreamBuilder<QueryEvent>(
                        ...
                        builder: (ctx, snapshot) {
                          if (!snapshot.hasData) {
                            ...
                            print("runtime type check under");
